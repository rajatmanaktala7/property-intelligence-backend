...
def robust_match_requirement(rid,create_whatsapp=False):
    ...
    if create_whatsapp and matches:
        ...
        tops=[property_map[x["property_id"]] for x in matches[:5] if x["property_id"] in property_map]
...
<div class="grid2"><div class="card"><h3>Add Property Manually</h3><div class="msg">Now includes Owner Name, Broker Name, Main/Owner/Broker Contact Numbers, Rent in figures, Team Member, Verified/Unverified dropdown, and direct drag/drop image & video upload.</div><form class="formgrid" onsubmit="submitProperty(event)">
...
<input name="contact_number" placeholder="Main contact number"><select name="verification_status"><option value="UNVERIFIED">Unverified</option><option value="VERIFIED">Verified</option></select><input name="owner_name" placeholder="Owner name">
...
<div class="tablewrap"><table><thead><tr><th>#</th><th>Property</th><th>City</th><th>Location</th><th>Area</th><th>Rent</th><th>Score</th><th>Reasons</th><th>Data Gaps</th></tr></thead><tbody id="matchRows"></tbody></table></div></div></div>

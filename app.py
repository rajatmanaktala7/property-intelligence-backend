...
<div class="card"><h3>Commercial Intelligence</h3><p>Malls, commercial projects, government premises, brands present or announced, space availability, leasing contacts and high-potential brand opportunities.</p><a class="btn" href="/commercial-intelligence">Open Commercial Intelligence</a></div>
...
<a class="card bot" href="/newspaper"><b>📰 Newspaper Property Database</b><p>Capture full newspaper pages with AI Vision. Search, view, edit, verify, delete and export clean newspaper property records.</p></a>
...
# ALLIANCE V3.7.5 FINAL DASHBOARD ROUTE TAKEOVER
try:
    import team_dashboard_v375_takeover as _v375_takeover
    _v375_takeover.register(app, engine, need_login)
...
# FOUNDATION_5_1_2_AND_5_3_MAGAZINE_CHALLENGER_FRESH_V2
try:
    import sys as _m530_sys
    import alliance_magazine_fresh_v530 as _mag_v530
    _mag_v530.start(_m530_sys.modules[__name__])
    print("Alliance Magazine Challenger 5.1.2 + Fresh V2 5.3: registered")
except Exception as _m530_exc:
    print("Alliance Magazine V2 registration warning:", _m530_exc)

# FOUNDATION_5_1_3_AND_5_4_MAGAZINE_CHALLENGER_FRESH_V3
try:
    import sys as _m540_sys
    import alliance_magazine_fresh_v540 as _mag_v540
    _mag_v540.start(_m540_sys.modules[__name__])
...
# FOUNDATION_6_2_2_MAGAZINE_TARGETED_FIELD_REPAIR
try:
    import sys as _v622_sys
    import alliance_magazine_vision_lab_v622 as _v622
    _v622.start(_v622_sys.modules[__name__])

...
from alliance_v2_requirement_supply_intelligence import register_requirement_supply_routes
...
from alliance_v27_inventory_acquisition import register_v27_routes
...
from alliance_v30_orchestrator import register_v30_routes
...
from alliance_v34a_dashboard import register as register_v34a_dashboard_routes
...
def register(core):
    ...
    register_requirement_supply_routes(core)
    ...
    register_v34a_dashboard_routes(core)
    return app

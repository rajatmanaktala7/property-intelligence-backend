...
VERSION = "1.0.0-READ-ONLY-WHATSAPP-RECONCILIATION"
...
def register(core):
    ...
    if PAGE not in paths:
        ...
        def page_reconciliation():
            ...
            return HTMLResponse(f"""<!doctype html><html><head><meta charset='utf-8'><title>Alliance WhatsApp Reconciliation V1</title>
...
<h2>Alliance WhatsApp Ingestion Reconciliation V1</h2><p><b>Status:</b> {snap.get('status')} · READ ONLY ·

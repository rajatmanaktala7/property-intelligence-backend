...
def shell(title,body,active='Dashboard'):
    nav=[('Dashboard','/whatsapp-capture'),('WhatsApp Sources','/whatsapp-capture/sources'),('Clean Intelligence','/whatsapp-capture/intelligence'),('Master Database','/whatsapp-capture/database'),('Property Database','/whatsapp-capture/properties'),('Requirements','/whatsapp-capture/requirements'),('AI Matches','/whatsapp-capture/matches'),('Verification','/whatsapp-capture/verification'),('System Health','/whatsapp-capture/system-health')]

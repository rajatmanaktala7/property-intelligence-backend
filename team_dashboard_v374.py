...
<button class="active" onclick="tab('home',this)">Dashboard</button><button onclick="tab('requirements',this)">Requirements Centre</button><button onclick="tab('manualexact',this)">Manual Property Database</button><button onclick="tab('whatsapp',this)">WhatsApp Live</button><button onclick="tab('wacapture',this)">WhatsApp New Capture</button><button onclick="tab('marketing',this)">Marketing Contacts</button><a class="btn" href="/capture-intelligence?source_type=NEWSPAPER">Newspaper Capture</a><button onclick="tab('newspaper',this)">Newspaper Live</button><button onclick="tab('magazine',this)">Magazine Live</button><button onclick="tab('hospitality',this)">Hospitality Database</button><button onclick="tab('pipeline',this)">Live Property Pipeline</button>
...
<div class="template-grid">
  ...
  <div class="template-card"><div><h3>Newspaper Capture</h3><p>Upload the full newspaper page or PDF. Preserve the original source first, then run AI extraction.</p></div><div class="template-actions"><a class="btn primary" href="/capture-intelligence?source_type=NEWSPAPER">Upload &amp; Process Newspaper</a></div></div>
  <div class="template-card"><div><h3>Newspaper Live</h3><p>Search and verify the existing newspaper property database.</p></div><div class="template-actions"><button class="btn green" onclick="tab('newspaper',document.querySelector('.tabs button[onclick*=newspaper]'))">Open Newspaper Database</button></div></div>

...
<div class="card" id="newspaper-database"><h2>📰 Newspaper Property Database</h2><div class="tablewrap"><table><thead><tr><th>Date</th><th>Lead Type</th><th>Locality</th><th>Area</th><th>Configuration / Details</th><th>Price</th><th>Agency / Brand</th><th>Contact</th><th>Phone</th><th>Verification</th><th>Actions</th></tr></thead><tbody id="rows"></tbody></table></div></div>

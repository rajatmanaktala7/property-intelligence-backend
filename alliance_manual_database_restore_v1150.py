...
VERSION="11.6.2-WIDE-SCROLL-MANUAL-GRID"
...
.tablebox{{overflow:auto;max-height:76vh;border:1px solid #667085}}table{{border-collapse:collapse;width:2100px;min-width:2100px;background:#fff;table-layout:fixed}}
th,td{{border:1px solid #98a2b3;padding:7px 9px;vertical-align:top;line-height:1.35;white-space:normal;overflow:hidden;overflow-wrap:anywhere;word-break:normal}}th{{background:#e9eef5;position:sticky;top:0;z-index:2;white-space:normal}}
th:nth-child(1),td:nth-child(1){{width:110px}}th:nth-child(2),td:nth-child(2){{width:190px}}th:nth-child(3),td:nth-child(3){{width:420px}}th:nth-child(4),td:nth-child(4){{width:170px}}th:nth-child(5),td:nth-child(5){{width:170px}}th:nth-child(6),td:nth-child(6){{width:120px}}th:nth-child(7),td:nth-child(7){{width:100px}}th:nth-child(8),td:nth-child(8){{width:130px}}th:nth-child(9),td:nth-child(9){{width:160px}}th:nth-child(10),td:nth-child(10){{width:140px}}th:nth-child(11),td:nth-child(11){{width:220px}}th:nth-child(12),td:nth-child(12){{width:120px}}th:nth-child(13),td:nth-child(13){{width:130px}}th:nth-child(14),td:nth-child(14){{width:110px}}tbody tr:nth-child(even) td{{background:#f8fafc}}</style></head>

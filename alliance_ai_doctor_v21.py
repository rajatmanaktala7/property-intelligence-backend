...
VERSION="2.4.0-ALLIANCE-ROUTE-AUTHORITY-DOCTOR"
...
def register(core,served_app=None):
    ...
    if not STATE["worker_started"]:
        ...
        threading.Thread(target=_worker,args=(target,),daemon=True,name="alliance-ai-doctor-v21").start()
    return {"status":result["status"],"version":VERSION,"interval_seconds":INTERVAL_SECONDS,"route_authority":"SERVED_PLUS_CORE","business_data_mutations":0,"matcher_routes_mutated":0,"requirement_routes_re_registered":0,"commercial_routes_re_registered":0,"newspaper_routes_re_registered":0}
